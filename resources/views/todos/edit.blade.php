...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        @if ($errors->any())
            <div class="alert alert-danger my-10 text-center">
                <ul>
        ...
        <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-12">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">内容編集</h1>
                    <p class="lg:w-2/3 mx-auto leading-relaxed text-base">やることリストの編集事項を記入してください</p>
                </div>
